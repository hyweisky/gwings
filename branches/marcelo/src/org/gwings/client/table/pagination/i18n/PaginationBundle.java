...
public interface PaginationBundle extends ImageBundle {
    ...
    @Resource("org/gwings/public/pics/pagingBar/new/FirstPage.gif")
    ...
    @Resource("org/gwings/public/pics/pagingBar/new/PreviousPage.gif")
    ...
    @Resource("org/gwings/public/pics/pagingBar/new/PreviousPage_disabled.gif")
    public AbstractImagePrototype previousDisabled();
    
    @Resource("org/gwings/public/pics/pagingBar/new/LastPage.gif")
    ...
    @Resource("org/gwings/public/pics/pagingBar/new/NextPage_disabled.gif")
    ...
    @Resource("org/gwings/public/pics/pagingBar/new/LastPage_disabled.gif")
    public AbstractImagePrototype lastDisabled();
    
    @Resource("org/gwings/public/pics/pagingBar/new/FirstPage_disabled.gif")
