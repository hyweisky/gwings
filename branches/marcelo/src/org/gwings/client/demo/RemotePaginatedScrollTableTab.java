 ...
 * @since 04/02/2007
 */
public class RemotePaginatedScrollTableTab extends AbstractDemoPanel {
	...
	public RemotePaginatedScrollTableTab() {
		initialize();
		setupUI();
		setupListener();
	}
...
//		AsyncDataProvider<LinePlotable> service = GWT.create(DataProvider.class);
		
		table = new PaginatedScrollTable<LinePlotable>();
		table.getPager().setPageConfig(config);
//		table.setProvider(service);
